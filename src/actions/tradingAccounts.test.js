...
import * as tradingAccountActions from './tradingAccountActions';
...
// Test a sync action
describe('TradingAccount Actions', () => {
  describe('createTradingAccountSuccess', () => {
    it('should create a CREATE_TRADING_ACCOUNT_SUCCESS action', () => {
      //arrange
      const tradingAccount = {Id: '57', Name: 'Test Account'};
      const expectedAction = {
        type: types.CREATE_TRADING_ACCOUNT_SUCCESS,
...
describe('Async Actions', () => {
  ...
  describe('TradingAccount Actions Thunk', () => {
    it('should create BEGIN_AJAX_CALL and LOAD_TRADING_ACCOUNTS_SUCCESS when loading tradingAccounts', (done) => {
      ...
      const expectedActions = [
        ...
        {type: types.LOAD_TRADING_ACCOUNTS_SUCCESS, body: {tradingAccounts: [{id: '34', title: 'Clean Code'}]}}
      ];
      ...
      store.dispatch(tradingAccountActions.loadTradingAccounts()).then(() => {
        ...
        expect(actions[1].type).toEqual(types.LOAD_TRADING_ACCOUNTS_SUCCESS);
        done();
      });
    });
  });
